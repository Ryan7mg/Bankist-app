...
const account1 = {
  ...
  movementsDates: [
    ...
    '2021-12-31T10:17:24.185Z',
    '2022-06-15T14:11:59.604Z',
...
const displayMovements = function (acc, sort = false) {
  containerMovements.innerHTML = ''; // returns everything including the HTML
  // .textcontent = 0
  ...
  movs.forEach(function (mov, i) {
    ...
    containerMovements.insertAdjacentHTML('afterbegin', html); // inserts new elements
  });
};
